...
namespace TweenPlayables.Editor
{
    ...
    [CustomPropertyDrawer(typeof(ChangeParameter<>), true)]
    public class ChangeParameterDrawer : PropertyDrawer
    {
        protected static readonly float headerHeight = EditorGUIUtility.singleLineHeight * 1.2f;
    ...
    [CustomPropertyDrawer(typeof(StringChangeParameter))]
    public sealed class StringChangeParameterDrawer : ChangeParameterDrawer
    {
        public override void DrawProperties(Rect position, SerializedProperty property)
        {
